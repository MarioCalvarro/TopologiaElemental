...
\end{prop}
\begin{demo}
    $\exists V^x (\stackrel{\text{ab.}}{\supset} W^x)$ compacto $\Rightarrow \mathcal{V}^x =$ \{entornos compactos $K^x$\} \underline{base de entornos}: $\forall U^x,\ \exists?K^x \subset U^x$.
