...
\begin{enumerate}
	...
	%TODO no entiendo este contraejemplo
...
\begin{prop}[Mantra 2]
Sea $X$ un espacio topológico $T_2$ y $Y\subset X$ un espacio localmente compacto, entonces es localmente cerrado.
\end{prop}
\begin{demo}
\[
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \incfig[0.6]{homeomorfismos-y-compactificación}
