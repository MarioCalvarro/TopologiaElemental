...
\]
Sabemos que $\exists U^a (\ab V^a) \mapsto f\left( U^a \right) (\ab V^{f\left( a \right)})$ al ser homeomorfismo. 
...
Por tanto, tiene un abierto ($W^{f\left( a \right)} \subset f\left( U \right)$) que es imagen de un abierto, $G$, en $X \rightarrow f\left( G \right) = W^{f\left( a \right)} \ab Y$, con $G \ab X$.
\end{demo}
\end{obs}
