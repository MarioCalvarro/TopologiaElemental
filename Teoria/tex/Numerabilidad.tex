...
\hline
    I Ax. & \checkmark & \begin{tabular}{@{}c@{}}$\times$\\ abiertos \checkmark \end{tabular} & \checkmark & \checkmark\\
    \hline
    II Ax. & \checkmark & \begin{tabular}{@{}c@{}}$\times$\\ abiertos \checkmark \end{tabular} & \checkmark & \checkmark\\
    \hline
    Separable & \begin{tabular}{@{}c@{}}$\times$\\ abiertos \checkmark \end{tabular} & \checkmark & \checkmark & \checkmark\\
    \hline
    Lindelöf & \begin{tabular}{@{}c@{}}$\times$\\ cerrados \checkmark \end{tabular} & \checkmark & $\times$ & \checkmark\\
    \hline
\end{tabular}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{demo}
            ...
            (Figura \ref{fig:I_ax_II_ax_cocientes}) $\Rightarrow U = \mathbb{R} \setminus \{\varepsilon_k : k \ge 1\}$ entorno abierto saturado de $\mathbb{Z},\ U \not \supset W_k,\ \forall k$.
