...
\begin{enumerate}
    ...
    \item Trivialmente? es inyectiva y continua. Por último, $X_i \rightarrow j\left( X_i \right)$ es homeomorfismo, es decir, que es abierta:
    \[
    \begin{cases}
    ...
    \end{cases}
    \]
    Estamos limitando la topología producto a $\left\{ a_i \right\} \times \ldots \times X_i \times \ldots \times \left\{ a_r \right\} = j\left( X_i \right)$.
\end{enumerate}
\end{demo}
