...
\underline{Problema:} Hacer $f: Y \rightarrow \left( X, \mathcal{T} \right)$ continua con $\begin{cases}
    \text{topología discreta en } Y \text{ (matricialidad)\footnote{Añadimos la característica de que la topología debe ser la menos fina para no tener simplemente la solución trivial de usar 
    la discreta.}}\\
...
\underline{Sol:} 
\begin{defi}    
Llamamos \underline{topología de la imagen inversa} a: $f^{-1} \mathcal{T} = \{f^{-1}U: U \in \mathcal{T}\}$, siendo $f$ continua.
\end{defi}
\begin{prop}    
